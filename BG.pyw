...
pygame.display.set_caption('Bad Guy')
...
class Game:
    ...
    def play_jbr(self):
        ...
        db.close()
        song_jbr = load_sound('music/BG.mp3')
        song_jbr.play()
...
if __name__ == '__main__':
    ...
    map_ = [3, 2, 0, 1, 3, 2, 1, 0, 2, 3, 1, 0, 3, 1, 0, 2, 1, 3, 0, 1, 3, 2,
